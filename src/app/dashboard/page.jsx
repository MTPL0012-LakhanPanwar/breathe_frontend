...
export default function DashboardPage() {
  ...
  const { user, isAuthenticated, successMessage, clearSuccessMessage } = useAuthStore();
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-6">Welcome, {user.username}!</h1>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-lg shadow-sm">
              <h2 className="text-lg font-semibold text-green-800 mb-2">Your Status</h2>
              <div className="flex items-center space-x-2 mb-4">
                <div className={`h-3 w-3 rounded-full ${user.isApproved ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-lg shadow-sm">
              <h2 className="text-lg font-semibold text-blue-800 mb-2">Chat with BREATHE AI</h2>
              <p className="text-sm text-gray-600 mb-4">
                Start a conversation with our AI assistant to explore mindfulness, sustainable living, and more.
              </p>
              <Button 
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-lg shadow-sm">
              <h2 className="text-lg font-semibold text-purple-800 mb-2">Account Type</h2>
